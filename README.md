...
If you copy the _reference genomes_ and _BWA index_ to a different location  after the test run, you can also change the lines in `conf/grzqc_GRCh37.config` and `conf/grzqc_GRCh38.config`.
